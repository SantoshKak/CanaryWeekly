...
const csvPath = 'C:/Users/Testriq_22/Desktop/canary_test/BonesCanary/cypress/fixtures/where2getit.csv';
    ...
    try{
        for (let url of urls) {
            try {
                ...
                // await context.close();
                 expect(await hasLoadingMessage).toBeTruthy;
                 expect(await hasWeeklyMessage).toBeTruthy;
